		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Salesorder",
									"targetURL": "#apsalesorder-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"apsalesorder-display": {
								"semanticObject": "apsalesorder",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ap.salesorder",
									"url": sap.ui.require.toUrl("ap/salesorder")
								}
							}
						}
					}
